...
//import actions
import { get_defaultMapData, HandleMapEnd, set_mapToPoint, update_ChartVisiblity, update_MapHeight, get_ChartData, change_geographyLevelActive,  change_geographyLevelFilter, set_MapLayers, set_LeafletMap, get_LayerInfo} from '../actions/actionCreators'
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    get_LayerInfo: bindActionCreators(get_LayerInfo,dispatch),
  }
}
