...
import { getNextLevel, getAGOGeographyLabel } from '../utils/helpers';
...
function ago_get_tra_by_id(hucid, current_geography_level){
  ...
  var level = getAGOGeographyLabel(current_geography_level)
...
export function get_ChartData(id,level){
    return (dispatch,getState) => {
      axios.all([AGO_AllChartData_byID(id, level), ago_get_tra_by_id(id, level)])
