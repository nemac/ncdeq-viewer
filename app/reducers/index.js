...
import {chartDataByID, AllChartDataByID, chartData, fetching_chart, NLCDDATA, CATCHMENTDATA, active_function, chart_limit} from './ChartData';
import {geography_levels, change_geographyLevelActive, fetching_geo} from './GeographyLevels';
import {mapConfig, fetching_map, hoverInfo, active_hover} from './MapConfig';
...
const rootReducer = combineReducers( { menuLists, chartDataByID, AllChartDataByID, chartData, traData, geography_levels, change_geographyLevelActive, mapConfig,
                                       ...
                                       NLCDDATA, CATCHMENTDATA, hoverInfo, active_function, chart_limit, active_hover} );
