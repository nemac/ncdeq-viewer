...
const rootReducer = combineReducers( { menuLists, chartDataByID, AllChartDataByID, chartData, geography_levels, change_geographyLevelActive, mapConfig, default_settings,routing: routerReducer} );
